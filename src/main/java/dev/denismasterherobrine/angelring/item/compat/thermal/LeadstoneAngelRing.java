...
import dev.denismasterherobrine.angelring.compat.thermal.integration.LeadstoneAngelRingIntegration;
...
public class LeadstoneAngelRing extends Item {
    public LeadstoneAngelRing() {
